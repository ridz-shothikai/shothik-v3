...
export function useChangeTracking(
  ...
  const revertTextChange = useCallback(
    (change: Change): boolean => {
      ...
      if (!element) {
        ...
        showErrorSnackbar("Cannot undo: Element not found");
        return false;
      }
      ...
      if (!previousHtml) {
        ...
        showErrorSnackbar("Cannot undo: Invalid change data");
        return false;
      }
    ...
    [findElement, showErrorSnackbar, getElementPathFromChange],
  );
  ...
  const reapplyTextChange = useCallback(
    (change: Change): boolean => {
      ...
      if (!element) {
        ...
        showErrorSnackbar("Cannot redo: Element not found");
        return false;
      }
      ...
      if (!html) {
        ...
        showErrorSnackbar("Cannot redo: Invalid change data");
        return false;
      }
  ...
  const revertDeleteChange = useCallback(
    (change: Change): boolean => {
      ...
      if (!doc) {
        ...
        showErrorSnackbar("Cannot undo: Editor not ready");
        return false;
      }
      ...
      if (!restoredElement) {
        ...
        showErrorSnackbar("Cannot undo: Failed to restore element");
        return false;
      }
    ...
    [getIframeDoc, showErrorSnackbar],
  );
  ...
  const reapplyDeleteChange = useCallback(
    (change: Change): boolean => {
      ...
      if (!parent) {
        ...
        showErrorSnackbar("Cannot redo: Element has no parent");
        return false;
      }
  ...
  const revertDuplicateChange = useCallback(
    (change: Change): boolean => {
      ...
      if (!clonedElement) {
        ...
        showErrorSnackbar("Cannot undo: Cloned element not found");
        return false;
      }
      ...
      if (!parent) {
        ...
        showErrorSnackbar("Cannot undo: Cloned element has no parent");
        return false;
      }
  ...
  const reapplyDuplicateChange = useCallback(
    (change: Change): boolean => {
      ...
      if (!doc) {
        ...
        showErrorSnackbar("Cannot redo: Editor not ready");
        return false;
      }
      ...
      if (!originalElement) {
        ...
        showErrorSnackbar("Cannot redo: Original element not found");
        return false;
      }
      ...
      if (!clonedElement) {
        ...
        showErrorSnackbar("Cannot redo: Failed to restore cloned element");
        return false;
      }
      ...
      if (!parent) {
        ...
        showErrorSnackbar("Cannot redo: Original element has no parent");
        return false;
      }
    ...
    [getIframeDoc, findElement, showErrorSnackbar, getElementPathFromChange],
  );
  ...
  const undoChange = useCallback(() => {
    ...
    if (!change) {
      ...
      showErrorSnackbar("Cannot undo: Change not found");
      return false;
    }
  ...
  const redoChange = useCallback(() => {
    ...
    if (!change) {
      ...
      showErrorSnackbar("Cannot redo: Change not found");
      return false;
    }
