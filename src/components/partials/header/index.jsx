...
const featuresMenuContent = {
  writing: {
    title: "Writing",
    items: [
      { label: "Paraphraser", icon: Edit, href: "/features#writing" },
      { label: "AI Detector", icon: Brain, href: "/features#writing" },
      { label: "Humanizer", icon: Sparkles, href: "/features#writing" },
      {
        label: "Grammar Checker",
        icon: CheckCheck,
        href: "/features#writing",
      },
      { label: "Summarizer", icon: CheckCheck, href: "/features#writing" },
      { label: "Translator", icon: Languages, href: "/features#writing" },
      {
        label: "Plagiarism",
        icon: FileText,
        href: "/features#writing",
    ...
    items: [
      {
        ...
        icon: FileText,
        href: "/features#marketing-automation1",
      },
      {
        label: "AI Strategy Generation",
        icon: Lightbulb,
        href: "/features#marketing-automation2",
      },
      {
        label: "AI Ad Sets",
        icon: Images,
        href: "/features#marketing-automation3",
      },
      {
