  ...
  return (
    <div className="bg-background flex h-screen overflow-hidden">
      ...
      <div className="flex h-full flex-1 flex-col">
        {/* Header */}
        <div className="border-border bg-background/90 shrink-0 border-b px-6 py-3 backdrop-blur-sm">
        ...
        {/* Input Area */}
        <div className="border-border bg-muted/50 shrink-0 border-t px-6 py-3">
      ...
      {/* Studio Panel */}
      <div className="border-border bg-muted/50 flex h-full w-80 flex-col md:border-s">
        {/* Studio Header */}
