...
export default function UGCVideoSection() {
  ...
  return (
    <div className="bg-background text-foreground flex flex-1 flex-col overflow-hidden p-6">
      {/* Header */}
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <Button
                    ...
                    className="flex h-auto min-h-9 flex-col gap-2 py-2"
                  >
                    <div className="leading-none font-semibold">Fast</div>
