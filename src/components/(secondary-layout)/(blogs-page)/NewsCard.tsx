      ...
      <Link href={`/blogs/${id}`}>
        ...
        featured && "md:col-span-2 md:row-span-2",
          ...
          <div className="flex-1 p-6">
            <h2 className="group-hover:text-muted-foreground mb-3 text-2xl leading-tight font-semibold transition-colors">
              {title}
            </h2>
  ...
  if (featured && viewMode === "grid") {
    return (
      <Link href={`/blogs/${id}`}>
        ...
        >
          <div className="relative h-[420px] w-full overflow-hidden rounded-t-2xl">
            <Image
              src={imgSrc}
              alt={title}
              fill
          ...
          <div className="p-6">
            <h2 className="mb-4 text-3xl leading-tight font-semibold md:text-4xl">
              {title}
            </h2>
    ...
    <Link href={`/blogs/${id}`}>
      ...
      >
        ...
        <div className="p-6">
          <h2
            className={cn(
              "group-hover:text-muted-foreground mb-3 leading-tight font-semibold transition-colors",
